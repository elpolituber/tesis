...
class CreateTeacherParticipantsTable extends Migration
{
    ...
    public function up()
    {
        Schema::connection('pgsql-vinculacion')->create('teacher_participants', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('funtion_id',100)->constrained('catalogues');//rol asignado catalogo 
            $table->timestamps();
        });
    }
